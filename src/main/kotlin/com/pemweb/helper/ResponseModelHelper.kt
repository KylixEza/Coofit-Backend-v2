package com.pemweb.helper

import com.pemweb.model.GeneralListResponse
import com.pemweb.model.GeneralResponse
import io.ktor.application.*
import io.ktor.features.*
import io.ktor.http.*
import io.ktor.response.*

object ResponseModelHelper {
	suspend inline fun<reified T> ApplicationCall.generalSuccess(
		dataReplacementMessage: String = "",
		...
		try {
			...
			this.respond(
				...
				GeneralResponse(
					...
					"Success",
					if (data is Unit) dataReplacementMessage else data
				)
			)
		} catch (e: Exception) {
	...
	suspend inline fun<reified T> ApplicationCall.generalListSuccess(
		noinline action: suspend () -> T
	) {
		try {
